(function ($) {
  $(document).ready(function() {
    ...
    window.index.add({
      href: 'https://spoor.app/station/NM/',
      title: 'Nijmegen',
    ...
    window.index.add({
      href: 'https://spoor.app/autocomplete.html',
      title: 'Autocomplete',
    ...
    window.index.add({
      href: 'https://spoor.app/breadcrumbs.html',
      title: 'Breadcrumbs',
      body: 'There are 3 main button types described in material design. The raised button is a standard button that signify actions and seek to give depth to a mostly flat page. The floating circular action button is meant for very important functions. Flat buttons are usually used within elements that already have depth like cards or modals.'
    });

    window.index.add({
      href: 'https://spoor.app/cards.html',
      title: 'Cards',
    ...
    window.index.add({
      href: 'https://spoor.app/carousel.html',
      title: 'Carousel',
    ...
    window.index.add({
      href: 'https://spoor.app/checkboxes.html',
      title: 'Checkboxes',
    ...
    window.index.add({
      href: 'https://spoor.app/chips.html',
      title: 'Chips',
    ...
    window.index.add({
      href: 'https://spoor.app/collapsible.html',
      title: 'Collapsible',
    ...
    window.index.add({
      href: 'https://spoor.app/collections.html',
      title: 'Collections',
      body: 'Collections allow you to group list objects together.'
    });

    window.index.add({
      href: 'https://spoor.app/color.html',
      title: 'Color',
    ...
    window.index.add({
      href: 'https://spoor.app/dropdown.html',
      title: 'dropdown',
      body: 'Add a dropdown list to any button.'
    });

    window.index.add({
      href: 'https://spoor.app/feature-discovery.html',
    ...
    window.index.add({
      href: 'https://spoor.app/footer.html',
      title: 'footer',
    ...
    window.index.add({
      href: 'https://spoor.app/helpers.html',
      title: 'Helpers',
      body: 'helper classes'
    });

    window.index.add({
      href: 'https://spoor.app/icons.html',
      title: 'icons',
      body: 'We have included 740 Material Design Icons courtesy of Google'
    });

    window.index.add({
      href: 'https://spoor.app/media-css.html',
      title: 'Media CSS',
      body: 'Media CSS classes'
    });

    window.index.add({
      href: 'https://spoor.app/media.html',
    ...
    window.index.add({
      href: 'https://spoor.app/pickers.html',
      title: 'date time picker',
      body: 'Pickers provide a simple way to select a date or time.'
    });

    window.index.add({
      href: 'https://spoor.app/preloader.html',
      title: 'preloader',
    ...
    window.index.add({
      href: 'https://spoor.app/select.html',
      title: 'Select',
      body: 'Select allows user input through specified options.'
    });

    window.index.add({
      href: 'https://spoor.app/shadow.html',
      title: 'shadow',
    ...
    window.index.add({
      href: 'https://spoor.app/showcase.html',
      title: 'showcase',
      body: 'Here is our showcase of websites that use materialize.'
    });

    window.index.add({
      href: 'https://spoor.app/sidenav.html',
    ...
    window.index.add({
      href: 'https://spoor.app/tabs.html',
      title: 'tabs',
    ...
    window.index.add({
      href: 'https://spoor.app/text-inputs.html',
    ...
    window.index.add({
      href: 'https://spoor.app/toasts.html',
      title: 'Toasts',
    ...
    window.index.add({
      href: 'https://spoor.app/tooltips.html',
      title: 'Tooltips',
    ...
    window.index.add({
      href: 'https://spoor.app/typography.html',
      title: 'Typography',
      body: 'font, headers, blockquotes, flow text.'
    });

    window.index.add({
      href: 'https://spoor.app/waves.html',
      title: 'waves',
    ...
    $('input#search').on('keyup', debounce(function (e) {
      ...
      var results = window.index.search(query).slice(0, 6).map(function (result) {
        var href = result.ref.split('https://spoor.app/')[1];
